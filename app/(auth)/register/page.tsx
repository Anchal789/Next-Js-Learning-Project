...
import { registerFormSubmit, RegisterState } from "@/actions/auth-actions";
...
const validate: Record<FieldName, (v: string) => string> = {
...
export default function RegisterPage() {
	const [state, formAction, loading] = useActionState<RegisterState, FormData>(
		registerFormSubmit,
		{},
	);
